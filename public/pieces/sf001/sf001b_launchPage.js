...
var panel = mkPanel('pid', canvas, w, h, "Soundflow #1b - Score Launcher", ['center-top', '0px', '0px', 'none'], 'xs', true);
var title = mkSpan(canvas, 'mainTitle', w, 24, 8, 105, 'Soundflow #1b - Justin Yang', 18, 'rgb(153,255,0)');
...
var launchScoreFunc = function() {
  ...
  location.href = "/pieces/sf001/sf001b.html?parts=" + partsStr + "&dataFileName=" + scoreDataFileName;
}
